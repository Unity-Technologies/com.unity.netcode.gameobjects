...
permalink: /api/on-value-changed-delegate_-t_/
---
...
<p>Delegate type for value changed event</p>
...
<div>
	...
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``OnValueChangedDelegate<T>``](/MLAPI/api/on-value-changed-delegate_-t_/)(``object`` object, ``IntPtr`` method);</b></h4>
	</div>
...
<div>
	...
	<div style="line-height: 1;">
		<h4 markdown="1"><b>public ``void`` Invoke(``T`` previousValue, ``T`` newValue);</b></h4>
		<h5><b>Parameters</b></h5>
		<div>
			<p style="font-size: 20px; color: #444;" markdown="1">``T`` previousValue</p>
		</div>
		<div>
			<p style="font-size: 20px; color: #444;" markdown="1">``T`` newValue</p>
		</div>
	</div>
	<br>
	<div style="line-height: 1;">
		<h4 markdown="1"><b>public ``IAsyncResult`` BeginInvoke(``T`` previousValue, ``T`` newValue, ``AsyncCallback`` callback, ``object`` object);</b></h4>
		<h5><b>Parameters</b></h5>
		<div>
			<p style="font-size: 20px; color: #444;" markdown="1">``T`` previousValue</p>
		</div>
