    ...
    public class MessageOrderingTests
    {
        ...
        public IEnumerator SpawnChangeOwnership()
        {
            ...
            yield return NetcodeIntegrationTestHelpers.Run(
                NetcodeIntegrationTestHelpers.WaitForClientsConnectedToServer(server, clients.Length + 1, null, 512));
        ...
        public IEnumerator RpcOnNetworkSpawn()
        {
            ...
            // [Host-Side] Check to make sure all clients are connected
            yield return NetcodeIntegrationTestHelpers.Run(
                NetcodeIntegrationTestHelpers.WaitForClientsConnectedToServer(server, clients.Length, null, 512));
