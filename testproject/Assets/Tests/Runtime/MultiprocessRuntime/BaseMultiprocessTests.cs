        ...
        public virtual IEnumerator Setup()
        {
            ...
            if (NetworkManager.Singleton.ConnectedClients.Count - 1 < WorkerCount)
            {
                ...
                for (int i = 1; i <= numProcessesToCreate; i++)
                {
                    ...
                    yield return new WaitForSeconds(0.9f); // Wait 0.9 seconds before starting the next process because there are odd contentions that happen when starting multiple processes quickly
