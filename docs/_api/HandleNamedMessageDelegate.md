---
title: HandleNamedMessageDelegate
name: HandleNamedMessageDelegate
permalink: /api/handle-named-message-delegate/
---

<div style="line-height: 1;">
	<h2 markdown="1">HandleNamedMessageDelegate ``class``</h2>
	<p style="font-size: 20px;"><b>Namespace:</b> MLAPI.Messaging</p>
	<p style="font-size: 20px;"><b>Assembly:</b> MLAPI.dll</p>
</div>
<p>Delegate used to handle named messages</p>
...
<div>
	...
	<div style="line-height: 1;">
		<h4 markdown="1"><b>public ``void`` Invoke(``ulong`` sender, ``Stream`` payload);</b></h4>
		<h5><b>Parameters</b></h5>
		<div>
			<p style="font-size: 20px; color: #444;" markdown="1">``ulong`` sender</p>
		</div>
		<div>
	...
	<br>
	<div style="line-height: 1;">
		<h4 markdown="1"><b>public ``IAsyncResult`` BeginInvoke(``ulong`` sender, ``Stream`` payload, ``AsyncCallback`` callback, ``object`` object);</b></h4>
		<h5><b>Parameters</b></h5>
		<div>
			<p style="font-size: 20px; color: #444;" markdown="1">``ulong`` sender</p>
		</div>
