---
title: VisibilityDelegate
name: VisibilityDelegate
permalink: /api/visibility-delegate/
---

<div style="line-height: 1;">
	<h2 markdown="1">VisibilityDelegate ``class``</h2>
	<p style="font-size: 20px;"><b>Namespace:</b> MLAPI</p>
	<p style="font-size: 20px;"><b>Assembly:</b> MLAPI.dll</p>
</div>
<p>Delegate type for checking visibility</p>
...
<div>
	...
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``VisibilityDelegate``](/MLAPI/api/visibility-delegate/)(``object`` object, ``IntPtr`` method);</b></h4>
	</div>
