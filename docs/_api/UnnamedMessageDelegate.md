---
title: UnnamedMessageDelegate
name: UnnamedMessageDelegate
permalink: /api/unnamed-message-delegate/
---

<div style="line-height: 1;">
	<h2 markdown="1">UnnamedMessageDelegate ``class``</h2>
	<p style="font-size: 20px;"><b>Namespace:</b> MLAPI.Messaging</p>
	<p style="font-size: 20px;"><b>Assembly:</b> MLAPI.dll</p>
</div>
<p>Delegate used for incoming unnamed messages</p>
...
<div>
	...
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``UnnamedMessageDelegate``](/MLAPI/api/unnamed-message-delegate/)(``object`` object, ``IntPtr`` method);</b></h4>
	</div>
