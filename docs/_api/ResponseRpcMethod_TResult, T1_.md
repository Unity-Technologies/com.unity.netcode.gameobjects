...
permalink: /api/response-rpc-method_-tresult, -t1_/
---
...
<div>
	...
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``ResponseRpcMethod<TResult, T1>``](/MLAPI/api/response-rpc-method_-tresult, -t1_/)(``object`` object, ``IntPtr`` method);</b></h4>
	</div>
