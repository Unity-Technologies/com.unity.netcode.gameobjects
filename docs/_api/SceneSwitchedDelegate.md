---
title: SceneSwitchedDelegate
name: SceneSwitchedDelegate
permalink: /api/scene-switched-delegate/
---

<div style="line-height: 1;">
	<h2 markdown="1">SceneSwitchedDelegate ``class``</h2>
	<p style="font-size: 20px;"><b>Namespace:</b> MLAPI.SceneManagement</p>
	<p style="font-size: 20px;"><b>Assembly:</b> MLAPI.dll</p>
</div>
<p>Delegate for when the scene has been switched</p>
...
<div>
	...
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``SceneSwitchedDelegate``](/MLAPI/api/scene-switched-delegate/)(``object`` object, ``IntPtr`` method);</b></h4>
	</div>
