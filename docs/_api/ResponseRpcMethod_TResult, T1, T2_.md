...
permalink: /api/response-rpc-method_-tresult, -t1, -t2_/
---
...
<div>
	...
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``ResponseRpcMethod<TResult, T1, T2>``](/MLAPI/api/response-rpc-method_-tresult, -t1, -t2_/)(``object`` object, ``IntPtr`` method);</b></h4>
	</div>
