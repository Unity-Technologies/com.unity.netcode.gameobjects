...
<div style="line-height: 1;">
	<h2 markdown="1">MoveValidationDelegate ``class``</h2>
	<p style="font-size: 20px;"><b>Namespace:</b> MLAPI.Prototyping</p>
	<p style="font-size: 20px;"><b>Assembly:</b> MLAPI.dll</p>
</div>
<p>The delegate used to check if a move is valid</p>
...
<div>
	...
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``MoveValidationDelegate``](/MLAPI/api/move-validation-delegate/)(``object`` object, ``IntPtr`` method);</b></h4>
	</div>
...
<div>
	...
	<div style="line-height: 1;">
		<h4 markdown="1"><b>public ``bool`` Invoke(``Vector3`` oldPos, ``Vector3`` newPos);</b></h4>
		<h5><b>Parameters</b></h5>
		<div>
			<p style="font-size: 20px; color: #444;" markdown="1">``Vector3`` oldPos</p>
		</div>
		<div>
			<p style="font-size: 20px; color: #444;" markdown="1">``Vector3`` newPos</p>
		</div>
	</div>
	<br>
	<div style="line-height: 1;">
		<h4 markdown="1"><b>public ``IAsyncResult`` BeginInvoke(``Vector3`` oldPos, ``Vector3`` newPos, ``AsyncCallback`` callback, ``object`` object);</b></h4>
		<h5><b>Parameters</b></h5>
		<div>
			<p style="font-size: 20px; color: #444;" markdown="1">``Vector3`` oldPos</p>
		</div>
