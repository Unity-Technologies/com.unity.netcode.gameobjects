---
title: Action<T1, T2, T3>
permalink: /api/action_-t1, -t2, -t3_/
---

<div style="line-height: 1;">
	<h2 markdown="1">Action&lt;T1, T2, T3&gt; ``class``</h2>
...
<div>
	...
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``Action<T1, T2, T3>``](/MLAPI/api/action_-t1, -t2, -t3_/)(``object`` object, ``IntPtr`` method);</b></h4>
	</div>
