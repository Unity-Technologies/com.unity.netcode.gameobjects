---
title: ResponseRpcMethod&lt;TResult,T1,T2,T3,T4&gt;
name: ResponseRpcMethod<TResult,T1,T2,T3,T4>
permalink: /api/response-rpc-method%3C-tresult,-t1,-t2,-t3,-t4%3E/
---

<div style="line-height: 1;">
	<h2 markdown="1">ResponseRpcMethod&lt;TResult,T1,T2,T3,T4&gt; ``class``</h2>
...
<div>
	...
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``ResponseRpcMethod<TResult,T1,T2,T3,T4>``](/MLAPI/api/response-rpc-method%3C-tresult,-t1,-t2,-t3,-t4%3E/)(``object`` object, ``IntPtr`` method);</b></h4>
	</div>
...
<div>
	...
	<div style="line-height: 1;">
		<h4 markdown="1"><b>public ``TResult`` Invoke(``T1`` t1, ``T2`` t2, ``T3`` t3, ``T4`` t4);</b></h4>
		<h5><b>Parameters</b></h5>
		<div>
	...
	<br>
	<div style="line-height: 1;">
		<h4 markdown="1"><b>public ``IAsyncResult`` BeginInvoke(``T1`` t1, ``T2`` t2, ``T3`` t3, ``T4`` t4, ``AsyncCallback`` callback, ``object`` object);</b></h4>
		<h5><b>Parameters</b></h5>
		<div>
			<p style="font-size: 20px; color: #444;" markdown="1">``T1`` t1</p>
		</div>
