...
permalink: /api/response-rpc-method_-tresult, -t1, -t2, -t3, -t4_/
---
...
<div>
	...
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``ResponseRpcMethod<TResult, T1, T2, T3, T4>``](/MLAPI/api/response-rpc-method_-tresult, -t1, -t2, -t3, -t4_/)(``object`` object, ``IntPtr`` method);</b></h4>
	</div>
