---
title: ResponseRpcMethod&lt;TResult,T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11&gt;
name: ResponseRpcMethod<TResult,T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11>
permalink: /api/response-rpc-method%3C-tresult,-t1,-t2,-t3,-t4,-t5,-t6,-t7,-t8,-t9,-t10,-t11%3E/
---

<div style="line-height: 1;">
	<h2 markdown="1">ResponseRpcMethod&lt;TResult,T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11&gt; ``class``</h2>
...
<div>
	...
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``ResponseRpcMethod<TResult,T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11>``](/MLAPI/api/response-rpc-method%3C-tresult,-t1,-t2,-t3,-t4,-t5,-t6,-t7,-t8,-t9,-t10,-t11%3E/)(``object`` object, ``IntPtr`` method);</b></h4>
	</div>
...
<div>
	...
	<div style="line-height: 1;">
		<h4 markdown="1"><b>public ``TResult`` Invoke(``T1`` t1, ``T2`` t2, ``T3`` t3, ``T4`` t4, ``T5`` t5, ``T6`` t6, ``T7`` t7, ``T8`` t8, ``T9`` t9, ``T10`` t10, ``T11`` t11);</b></h4>
		<h5><b>Parameters</b></h5>
		<div>
