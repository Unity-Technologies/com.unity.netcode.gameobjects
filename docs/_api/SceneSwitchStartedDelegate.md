---
title: SceneSwitchStartedDelegate
name: SceneSwitchStartedDelegate
permalink: /api/scene-switch-started-delegate/
---

<div style="line-height: 1;">
	<h2 markdown="1">SceneSwitchStartedDelegate ``class``</h2>
	<p style="font-size: 20px;"><b>Namespace:</b> MLAPI.SceneManagement</p>
	<p style="font-size: 20px;"><b>Assembly:</b> MLAPI.dll</p>
</div>
<p>Delegate for when a scene switch has been initiated</p>
...
<div>
	...
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``SceneSwitchStartedDelegate``](/api/scene-switch-started-delegate/)(``object`` object, ``IntPtr`` method);</b></h4>
	</div>
...
<div>
	...
	<div style="line-height: 1;">
		<h4 markdown="1"><b>public ``void`` Invoke(``AsyncOperation`` operation);</b></h4>
		<h5><b>Parameters</b></h5>
		<div>
			<p style="font-size: 20px; color: #444;" markdown="1">``AsyncOperation`` operation</p>
		</div>
	</div>
	<br>
	<div style="line-height: 1;">
		<h4 markdown="1"><b>public ``IAsyncResult`` BeginInvoke(``AsyncOperation`` operation, ``AsyncCallback`` callback, ``object`` object);</b></h4>
		<h5><b>Parameters</b></h5>
		<div>
			<p style="font-size: 20px; color: #444;" markdown="1">``AsyncOperation`` operation</p>
		</div>
