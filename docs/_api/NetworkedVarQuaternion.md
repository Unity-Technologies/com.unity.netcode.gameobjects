...
<div>
	...
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``NetworkedVarQuaternion``](/api/networked-var-quaternion/)();</b></h4>
	</div>
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``NetworkedVarQuaternion``](/api/networked-var-quaternion/)([``NetworkedVarSettings``](/api/networked-var-settings/) settings);</b></h4>
	</div>
	...
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``NetworkedVarQuaternion``](/api/networked-var-quaternion/)(``Quaternion`` value);</b></h4>
	</div>
		<h5><b>Parameters</b></h5>
		<div>
	...
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``NetworkedVarQuaternion``](/api/networked-var-quaternion/)([``NetworkedVarSettings``](/api/networked-var-settings/) settings, ``Quaternion`` value);</b></h4>
	</div>
		<h5><b>Parameters</b></h5>
		<div>
			<p style="font-size: 20px; color: #444;" markdown="1">[``NetworkedVarSettings``](/api/networked-var-settings/) settings</p>
