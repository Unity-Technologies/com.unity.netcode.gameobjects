...
<div style="line-height: 1;">
	<h2 markdown="1">NetworkedVarQuaternion ``class``</h2>
	<p style="font-size: 20px;"><b>Namespace:</b> MLAPI</p>
	<p style="font-size: 20px;"><b>Assembly:</b> MLAPI.dll</p>
</div>
<p>A NetworkedVar that holds quaternions and support serialization</p>

<div>
	<h3 markdown="1">Inherited Properties</h3>
	<div style="line-height: 1;">
		<h4 markdown="1"><b>public ``bool`` isDirty { get; set; }</b></h4>
		<h5 markdown="1">Inherited from: ``NetworkedVar<Quaternion>``</h5>
	</div>
	<div style="line-height: 1;">
	...
	<div style="line-height: 1;">
		<h4 markdown="1"><b>public ``Quaternion`` Value { get; set; }</b></h4>
		<h5 markdown="1">Inherited from: ``NetworkedVar<Quaternion>``</h5>
	</div>
</div>
<br>
<div>
	...
	<div style="line-height: 1;">
		<h4 markdown="1"><b>public ``OnValueChangedDelegate<Quaternion>`` OnValueChanged;</b></h4>
		<h5 markdown="1">Inherited from: ``NetworkedVar<Quaternion>``</h5>
	</div>
</div>
<br>
<div>
	...
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``NetworkedVarQuaternion``](/MLAPI/api/networked-var-quaternion/)();</b></h4>
	</div>
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``NetworkedVarQuaternion``](/MLAPI/api/networked-var-quaternion/)([``NetworkedVarSettings``](/MLAPI/api/networked-var-settings/) settings);</b></h4>
	</div>
	...
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``NetworkedVarQuaternion``](/MLAPI/api/networked-var-quaternion/)(``Quaternion`` value);</b></h4>
	</div>
		<h5><b>Parameters</b></h5>
		<div>
			<p style="font-size: 20px; color: #444;" markdown="1">``Quaternion`` value</p>
		</div>
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``NetworkedVarQuaternion``](/MLAPI/api/networked-var-quaternion/)([``NetworkedVarSettings``](/MLAPI/api/networked-var-settings/) settings, ``Quaternion`` value);</b></h4>
	</div>
		<h5><b>Parameters</b></h5>
		<div>
			<p style="font-size: 20px; color: #444;" markdown="1">[``NetworkedVarSettings``](/MLAPI/api/networked-var-settings/) settings</p>
