---
title: RpcMethod&lt;T1,T2,T3,T4,T5&gt;
name: RpcMethod<T1,T2,T3,T4,T5>
permalink: /api/rpc-method%3C-t1,-t2,-t3,-t4,-t5%3E/
---

<div style="line-height: 1;">
	<h2 markdown="1">RpcMethod&lt;T1,T2,T3,T4,T5&gt; ``class``</h2>
...
<div>
	...
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``RpcMethod<T1,T2,T3,T4,T5>``](/MLAPI/api/rpc-method%3C-t1,-t2,-t3,-t4,-t5%3E/)(``object`` object, ``IntPtr`` method);</b></h4>
	</div>
...
<div>
	...
	<div style="line-height: 1;">
		<h4 markdown="1"><b>public ``void`` Invoke(``T1`` t1, ``T2`` t2, ``T3`` t3, ``T4`` t4, ``T5`` t5);</b></h4>
		<h5><b>Parameters</b></h5>
		<div>
