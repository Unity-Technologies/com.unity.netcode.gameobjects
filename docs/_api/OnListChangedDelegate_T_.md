...
<div style="line-height: 1;">
	<h2 markdown="1">OnListChangedDelegate&lt;T&gt; ``class``</h2>
	<p style="font-size: 20px;"><b>Namespace:</b> MLAPI.NetworkedVar.Collections</p>
	<p style="font-size: 20px;"><b>Assembly:</b> MLAPI.dll</p>
</div>
<p>Delegate type for list changed event</p>
...
<div>
	...
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``OnListChangedDelegate<T>``](/api/on-list-changed-delegate%3C-t%3E/)(``object`` object, ``IntPtr`` method);</b></h4>
	</div>
...
<div>
	...
	<div style="line-height: 1;">
		<h4 markdown="1"><b>public ``void`` Invoke(``NetworkedListEvent<T>`` changeEvent);</b></h4>
		<h5><b>Parameters</b></h5>
		<div>
			<p style="font-size: 20px; color: #444;" markdown="1">``NetworkedListEvent<T>`` changeEvent</p>
		</div>
	</div>
	<br>
	<div style="line-height: 1;">
		<h4 markdown="1"><b>public ``IAsyncResult`` BeginInvoke(``NetworkedListEvent<T>`` changeEvent, ``AsyncCallback`` callback, ``object`` object);</b></h4>
		<h5><b>Parameters</b></h5>
		<div>
			<p style="font-size: 20px; color: #444;" markdown="1">``NetworkedListEvent<T>`` changeEvent</p>
		</div>
