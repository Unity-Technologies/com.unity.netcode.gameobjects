---
title: Action<T1, T2>
permalink: /api/action_-t1, -t2_/
---

<div style="line-height: 1;">
	<h2 markdown="1">Action&lt;T1, T2&gt; ``class``</h2>
...
<div>
	...
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``Action<T1, T2>``](/MLAPI/api/action_-t1, -t2_/)(``object`` object, ``IntPtr`` method);</b></h4>
	</div>
