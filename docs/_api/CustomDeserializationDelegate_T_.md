---
title: CustomDeserializationDelegate&lt;T&gt;
name: CustomDeserializationDelegate<T>
permalink: /api/custom-deserialization-delegate%3C-t%3E/
---

<div style="line-height: 1;">
	<h2 markdown="1">CustomDeserializationDelegate&lt;T&gt; ``class``</h2>
	<p style="font-size: 20px;"><b>Namespace:</b> MLAPI.Serialization</p>
	<p style="font-size: 20px;"><b>Assembly:</b> MLAPI.dll</p>
</div>
<p>The delegate used when registering custom deserialization for a type.</p>
...
<div>
	...
	<div style="line-height: 1;">
		<h4 markdown="1"><b>public ``T`` Invoke(``Stream`` stream);</b></h4>
		<h5><b>Parameters</b></h5>
		<div>
	...
	<br>
	<div style="line-height: 1;">
		<h4 markdown="1"><b>public ``IAsyncResult`` BeginInvoke(``Stream`` stream, ``AsyncCallback`` callback, ``object`` object);</b></h4>
		<h5><b>Parameters</b></h5>
		<div>
			<p style="font-size: 20px; color: #444;" markdown="1">``Stream`` stream</p>
		</div>
	...
	<br>
	<div style="line-height: 1;">
		<h4 markdown="1"><b>public ``T`` EndInvoke(``IAsyncResult`` result);</b></h4>
		<h5><b>Parameters</b></h5>
		<div>
