---
title: Action<T1, T2, T3, T4, T5, T6>
permalink: /api/action_-t1, -t2, -t3, -t4, -t5, -t6_/
---

<div style="line-height: 1;">
	<h2 markdown="1">Action&lt;T1, T2, T3, T4, T5, T6&gt; ``class``</h2>
...
<div>
	...
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``Action<T1, T2, T3, T4, T5, T6>``](/MLAPI/api/action_-t1, -t2, -t3, -t4, -t5, -t6_/)(``object`` object, ``IntPtr`` method);</b></h4>
	</div>
...
<div>
	...
	<div style="line-height: 1;">
		<h4 markdown="1"><b>public ``void`` Invoke(``T1`` t1, ``T2`` t2, ``T3`` t3, ``T4`` t4, ``T5`` t5, ``T6`` t6);</b></h4>
		<h5><b>Parameters</b></h5>
		<div>
