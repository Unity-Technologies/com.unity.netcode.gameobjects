---
title: NetworkedVarVector3
name: NetworkedVarVector3
permalink: /api/networked-var-vector3/
---

<div style="line-height: 1;">
	<h2 markdown="1">NetworkedVarVector3 ``class``</h2>
	<p style="font-size: 20px;"><b>Namespace:</b> MLAPI.NetworkedVar</p>
	<p style="font-size: 20px;"><b>Assembly:</b> MLAPI.dll</p>
</div>
<p>A NetworkedVar that holds vector3s and support serialization</p>

<div>
	<h3 markdown="1">Inherited Properties</h3>
	<div style="line-height: 1;">
		<h4 markdown="1"><b>public ``bool`` isDirty { get; set; }</b></h4>
		<h5 markdown="1">Inherited from: ``NetworkedVar<Vector3>``</h5>
	</div>
	<div style="line-height: 1;">
	...
	<div style="line-height: 1;">
		<h4 markdown="1"><b>public ``Vector3`` Value { get; set; }</b></h4>
		<h5 markdown="1">Inherited from: ``NetworkedVar<Vector3>``</h5>
	</div>
</div>
<br>
<div>
	...
	<div style="line-height: 1;">
		<h4 markdown="1"><b>public ``OnValueChangedDelegate<Vector3>`` OnValueChanged;</b></h4>
		<h5 markdown="1">Inherited from: ``NetworkedVar<Vector3>``</h5>
	</div>
</div>
<br>
<div>
	...
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``NetworkedVarVector3``](/MLAPI/api/networked-var-vector3/)();</b></h4>
	</div>
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``NetworkedVarVector3``](/MLAPI/api/networked-var-vector3/)([``NetworkedVarSettings``](/MLAPI/api/networked-var-settings/) settings);</b></h4>
	</div>
	...
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``NetworkedVarVector3``](/MLAPI/api/networked-var-vector3/)(``Vector3`` value);</b></h4>
	</div>
		<h5><b>Parameters</b></h5>
		<div>
			<p style="font-size: 20px; color: #444;" markdown="1">``Vector3`` value</p>
		</div>
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``NetworkedVarVector3``](/MLAPI/api/networked-var-vector3/)([``NetworkedVarSettings``](/MLAPI/api/networked-var-settings/) settings, ``Vector3`` value);</b></h4>
	</div>
		<h5><b>Parameters</b></h5>
		<div>
			<p style="font-size: 20px; color: #444;" markdown="1">[``NetworkedVarSettings``](/MLAPI/api/networked-var-settings/) settings</p>
