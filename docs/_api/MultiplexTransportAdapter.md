---
title: MultiplexTransportAdapter
name: MultiplexTransportAdapter
permalink: /api/multiplex-transport-adapter/
---

<div style="line-height: 1;">
	<h2 markdown="1">MultiplexTransportAdapter ``class``</h2>
	<p style="font-size: 20px;"><b>Namespace:</b> MLAPI.Transports.Multiplex</p>
	<p style="font-size: 20px;"><b>Assembly:</b> MLAPI.dll</p>
</div>
<p>Multiplex transport adapter.</p>
...
<div>
	...
	<br>
	<div style="line-height: 1;">
		<h4 markdown="1"><b>public ``ulong`` GetMLAPIClientId(``byte`` transportId, ``ulong`` connectionId, ``bool`` isServer);</b></h4>
		<h5><b>Parameters</b></h5>
		<div>
			<p style="font-size: 20px; color: #444;" markdown="1">``byte`` transportId</p>
		</div>
		<div>
			<p style="font-size: 20px; color: #444;" markdown="1">``ulong`` connectionId</p>
		</div>
		<div>
	...
	<br>
	<div style="line-height: 1;">
		<h4 markdown="1"><b>public ``void`` GetMultiplexTransportDetails(``ulong`` clientId, ``Byte&`` transportId, ``UInt64&`` connectionId);</b></h4>
		<h5><b>Parameters</b></h5>
		<div>
			<p style="font-size: 20px; color: #444;" markdown="1">``ulong`` clientId</p>
		</div>
		...
		<div>
			<p style="font-size: 20px; color: #444;" markdown="1">``UInt64&`` connectionId</p>
		</div>
	</div>
	<br>
	<div style="line-height: 1;">
		<h4 markdown="1"><b>public ``byte`` GetFirstSupportedTransportIndex();</b></h4>
	</div>
	<br>
</div>
<br>
