---
title: NetworkedVarVector2
name: NetworkedVarVector2
permalink: /api/networked-var-vector2/
---

<div style="line-height: 1;">
	<h2 markdown="1">NetworkedVarVector2 ``class``</h2>
	<p style="font-size: 20px;"><b>Namespace:</b> MLAPI.NetworkedVar</p>
	<p style="font-size: 20px;"><b>Assembly:</b> MLAPI.dll</p>
</div>
<p>A NetworkedVar that holds vector2s and support serialization</p>

<div>
	<h3 markdown="1">Inherited Properties</h3>
	<div style="line-height: 1;">
		<h4 markdown="1"><b>public ``bool`` isDirty { get; set; }</b></h4>
		<h5 markdown="1">Inherited from: ``NetworkedVar<Vector2>``</h5>
	</div>
	<div style="line-height: 1;">
	...
	<div style="line-height: 1;">
		<h4 markdown="1"><b>public ``Vector2`` Value { get; set; }</b></h4>
		<h5 markdown="1">Inherited from: ``NetworkedVar<Vector2>``</h5>
	</div>
</div>
<br>
<div>
	...
	<div style="line-height: 1;">
		<h4 markdown="1"><b>public ``OnValueChangedDelegate<Vector2>`` OnValueChanged;</b></h4>
		<h5 markdown="1">Inherited from: ``NetworkedVar<Vector2>``</h5>
	</div>
</div>
<br>
<div>
	...
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``NetworkedVarVector2``](/MLAPI/api/networked-var-vector2/)();</b></h4>
	</div>
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``NetworkedVarVector2``](/MLAPI/api/networked-var-vector2/)([``NetworkedVarSettings``](/MLAPI/api/networked-var-settings/) settings);</b></h4>
	</div>
	...
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``NetworkedVarVector2``](/MLAPI/api/networked-var-vector2/)(``Vector2`` value);</b></h4>
	</div>
		<h5><b>Parameters</b></h5>
		<div>
			<p style="font-size: 20px; color: #444;" markdown="1">``Vector2`` value</p>
		</div>
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``NetworkedVarVector2``](/MLAPI/api/networked-var-vector2/)([``NetworkedVarSettings``](/MLAPI/api/networked-var-settings/) settings, ``Vector2`` value);</b></h4>
	</div>
		<h5><b>Parameters</b></h5>
		<div>
			<p style="font-size: 20px; color: #444;" markdown="1">[``NetworkedVarSettings``](/MLAPI/api/networked-var-settings/) settings</p>
