---
title: SpawnStateException
name: SpawnStateException
permalink: /api/spawn-state-exception/
---

<div style="line-height: 1;">
	<h2 markdown="1">SpawnStateException ``class``</h2>
	<p style="font-size: 20px;"><b>Namespace:</b> MLAPI.Exceptions</p>
	<p style="font-size: 20px;"><b>Assembly:</b> MLAPI.dll</p>
</div>
<p>Exception thrown when an object is not yet spawned</p>
