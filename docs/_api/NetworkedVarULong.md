...
<div>
	...
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``NetworkedVarULong``](/MLAPI/api/networked-var-ulong/)();</b></h4>
	</div>
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``NetworkedVarULong``](/MLAPI/api/networked-var-ulong/)([``NetworkedVarSettings``](/MLAPI/api/networked-var-settings/) settings);</b></h4>
	</div>
	...
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``NetworkedVarULong``](/MLAPI/api/networked-var-ulong/)(``ulong`` value);</b></h4>
	</div>
		<h5><b>Parameters</b></h5>
		<div>
	...
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``NetworkedVarULong``](/MLAPI/api/networked-var-ulong/)([``NetworkedVarSettings``](/MLAPI/api/networked-var-settings/) settings, ``ulong`` value);</b></h4>
	</div>
		<h5><b>Parameters</b></h5>
		<div>
			<p style="font-size: 20px; color: #444;" markdown="1">[``NetworkedVarSettings``](/MLAPI/api/networked-var-settings/) settings</p>
