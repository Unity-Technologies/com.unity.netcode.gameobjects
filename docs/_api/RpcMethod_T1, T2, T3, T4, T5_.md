...
permalink: /api/rpc-method_-t1, -t2, -t3, -t4, -t5_/
---
...
<div>
	...
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``RpcMethod<T1, T2, T3, T4, T5>``](/MLAPI/api/rpc-method_-t1, -t2, -t3, -t4, -t5_/)(``object`` object, ``IntPtr`` method);</b></h4>
	</div>
