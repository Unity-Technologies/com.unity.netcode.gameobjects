...
<div>
	...
	<div style="line-height: 1; ">
		<h4 markdown="1"><b>public [``ResponseRpcMethod<TResult,T1,T2,T3,T4,T5,T6,T7>``](/api/response-rpc-method%3C-tresult,-t1,-t2,-t3,-t4,-t5,-t6,-t7%3E/)(``object`` object, ``IntPtr`` method);</b></h4>
	</div>
