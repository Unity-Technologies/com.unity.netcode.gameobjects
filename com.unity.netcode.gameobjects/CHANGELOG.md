...
- Fixed issue where a fast buffer reader overflow could happen when synchronizing a late joining player to a game session where in-scene placed NetworkObjects have been parented.
