...
namespace Unity.Netcode.Editor.CodeGen
{
    internal sealed class INetworkMessageILPP : ILPPInterface
    {
        ...
        {
            Console.WriteLine("bla: import references begin");
            ...
            {
                if (messageHandlerTypeDef == null && netcodeTypeDef.IsOfType<MessagingSystem.MessageHandler>())
                {
                    messageHandlerTypeDef = netcodeTypeDef;
                    continue;
                }

                if (messageWithHandlerTypeDef == null && netcodeTypeDef.IsOfType<MessagingSystem.MessageWithHandler>())
                {
                    messageWithHandlerTypeDef = netcodeTypeDef;
                    continue;
                }

                if (ilppMessageProviderTypeDef == null && netcodeTypeDef.IsOfType<ILPPMessageProvider>())
                {
                    ilppMessageProviderTypeDef = netcodeTypeDef;
                    continue;
                }

                if (messagingSystemTypeDef == null && netcodeTypeDef.IsOfType<MessagingSystem>())
                {
            ...
            Console.WriteLine($"messageHandlerTypeDef: {(messageHandlerTypeDef == null ? "null" : "set")}");
            Console.WriteLine($"messageWithHandlerTypeDef: {(messageWithHandlerTypeDef == null ? "null" : "set")}");
            Console.WriteLine($"ilppMessageProviderTypeDef: {(ilppMessageProviderTypeDef == null ? "null" : "set")}");
            // Console.WriteLine($"messageWithHandlerListTypeDef: {(messageWithHandlerListTypeDef == null ? "null" : "set")}");
            Console.WriteLine($"messagingSystemTypeDef: {(messagingSystemTypeDef == null ? "null" : "set")}");

            Console.WriteLine("bla: after netcode module foreach");
            ...
            Console.WriteLine("bla: after messagewithhandler");
            ...
            Console.WriteLine("bla: after gettypefromhandle");
            ...
            Console.WriteLine("bla: after network message types");
            ...
            Console.WriteLine("bla: after list add");
            ...
            Console.WriteLine("bla: import references end");
