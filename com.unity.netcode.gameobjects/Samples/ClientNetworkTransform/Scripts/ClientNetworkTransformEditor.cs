...
namespace Unity.Netcode.Editor
{
    ...
    public class NetworkTransformEditor : UnityEditor.Editor
    {
        ...
        {
            m_SyncPositionXProperty = serializedObject.FindProperty(nameof(ClientNetworkTransform.SyncPositionX));
            m_SyncPositionYProperty = serializedObject.FindProperty(nameof(ClientNetworkTransform.SyncPositionY));
            m_SyncPositionZProperty = serializedObject.FindProperty(nameof(ClientNetworkTransform.SyncPositionZ));
            m_SyncRotationXProperty = serializedObject.FindProperty(nameof(ClientNetworkTransform.SyncRotAngleX));
            m_SyncRotationYProperty = serializedObject.FindProperty(nameof(ClientNetworkTransform.SyncRotAngleY));
            m_SyncRotationZProperty = serializedObject.FindProperty(nameof(ClientNetworkTransform.SyncRotAngleZ));
            m_SyncScaleXProperty = serializedObject.FindProperty(nameof(ClientNetworkTransform.SyncScaleX));
            m_SyncScaleYProperty = serializedObject.FindProperty(nameof(ClientNetworkTransform.SyncScaleY));
            m_SyncScaleZProperty = serializedObject.FindProperty(nameof(ClientNetworkTransform.SyncScaleZ));
            m_PositionThresholdProperty = serializedObject.FindProperty(nameof(ClientNetworkTransform.PositionThreshold));
            m_RotAngleThresholdProperty = serializedObject.FindProperty(nameof(ClientNetworkTransform.RotAngleThreshold));
            m_ScaleThresholdProperty = serializedObject.FindProperty(nameof(ClientNetworkTransform.ScaleThreshold));
            m_InLocalSpaceProperty = serializedObject.FindProperty(nameof(ClientNetworkTransform.InLocalSpace));
            m_InterpolateProperty = serializedObject.FindProperty(nameof(ClientNetworkTransform.Interpolate));
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            var go = ((ClientNetworkTransform)target).gameObject;
