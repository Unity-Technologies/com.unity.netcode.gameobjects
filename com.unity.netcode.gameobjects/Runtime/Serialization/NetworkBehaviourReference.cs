...
namespace Unity.Netcode
{
    ...
    /// Network IDs get recycled by the NetworkManager after a while, so using a NetworkBehaviourReference for too long may result in a different NetworkBehaviour being returned for the assigned NetworkBehaviourId. NetworkBehaviourReferences are best for short-term use when receieved via RPC or custom message, rather than for long-term references to NetworkBehaviours.
    /// </summary>
