...
namespace Unity.Netcode
{
	...
	public class NetworkSpawnManager
	{
		...
		/// </remarks>
		internal NetworkObject CreateLocalNetworkObject(NetworkObject.SceneObject sceneObject, byte[] customSpawnData)
		{
			NetworkObject networkObject = null;
		...
		internal void SendSpawnCallForObserverUpdate(ulong[] newObservers, NetworkObject networkObject)
		{
			...
			Debug.Log("customSpawnData:2 SendSpawnCallForObserverUpdate" + message.CustomSpawnData.Length);
