...
{
    /// <summary>
    /// A variable that can be synchronized over the network, with a threshold to optimize replication
    /// </summary>
    /// <typeparam name="T">the unmanaged type for <see cref="NetworkVariableWithThreshold{T}"/> </typeparam>
    [Serializable]
    [GenerateSerializationForGenericParameter(0)]
    public abstract class NetworkVariableWithThreshold<T> : NetworkVariableBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Constructor for <see cref="NetworkVariableWithThreshold{T}"/>
        /// </summary>
        /// <param name="threshold">function to be invoked when the value gets changed to determine if this variable should gets dirty</param>
        /// <param name="value">initial value set that is of type T</param>
        /// <param name="readPerm">the <see cref="NetworkVariableReadPermission"/> for this <see cref="NetworkVariableWithThreshold{T}"/></param>
        /// <param name="writePerm">the <see cref="NetworkVariableWritePermission"/> for this <see cref="NetworkVariableWithThreshold{T}"/></param>
        public NetworkVariableWithThreshold(T threshold,
            T value = default,
        ...
        /// <summary>
        /// The threshold of the NetworkVariable
        /// </summary>
        [SerializeField]
        private protected T m_Threshold;
        ...
        private protected void Set(T value)
        {
            ...
            m_InternalValue = value;
            bool shouldSetDirty = ShouldSetDirty(ref m_PreviousValue, ref m_InternalValue);
            SetDirty(shouldSetDirty);
            OnValueChanged?.Invoke(previousValue, m_InternalValue);
        }

        /// <summary>
        /// Checks if a variable should be replicated
        /// </summary>
        /// <param name="previousValue">The value before the change</param>
        /// <param name="newValue">The new value</param>
        /// <returns>true is the value should be replicated</returns>
        protected abstract bool ShouldSetDirty(ref T previousValue, ref T newValue);
