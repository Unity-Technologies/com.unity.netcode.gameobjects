...
namespace Unity.Netcode
{
    internal interface IInternalMessageHandler
    {
        ...
        void MessageReceiveQueueItem(ulong clientId, Stream stream, float receiveTime, MessageQueueContainer.MessageType messageType, NetworkDelivery receiveDelivery);
