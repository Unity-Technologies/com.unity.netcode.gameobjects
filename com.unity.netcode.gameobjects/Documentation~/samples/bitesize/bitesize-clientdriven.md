...
<!-- CodeExample: bitesize-clientdriven-ThirdPersonController-L155-L162 https://github.com/Unity-Technologies/com.unity.multiplayer.samples.bitesize/blob/v1.2.1/Basic/ClientDriven/Assets/StarterAssets/ThirdPersonController/Scripts/ThirdPersonController.cs -->
[!code-csharp[ThirdPersonController](../../snippets/ThirdPersonController.cs#L155-L162)]
...
<!-- CodeExample: bitesize-clientdriven-ClientPlayerMove-L64-L94 https://github.com/Unity-Technologies/com.unity.multiplayer.samples.bitesize/blob/v1.2.1/Basic/ClientDriven/Assets/Scripts/ClientPlayerMove.cs -->
[!code-csharp[ClientPlayerMove](../../snippets/ClientPlayerMove.cs#L64-L94)]

But the pickup itself is done server side.

<!-- CodeExample: bitesize-clientdriven-ServerPlayerMove-L46-L82 https://github.com/Unity-Technologies/com.unity.multiplayer.samples.bitesize/blob/v1.2.1/Basic/ClientDriven/Assets/Scripts/ServerPlayerMove.cs -->
[!code-csharp[ServerPlayerMove](../../snippets/ServerPlayerMove.cs#L46-L82)]
...
<!-- CodeExample: bitesize-clientdriven-ServerPlayerMove-L50-L58 https://github.com/Unity-Technologies/com.unity.multiplayer.samples.bitesize/blob/v1.2.1/Basic/ClientDriven/Assets/Scripts/ServerPlayerMove.cs -->
[!code-csharp[ServerPlayerMove](../../snippets/ServerPlayerMove.cs#L50-L58)]
...
<!-- CodeExample: bitesize-clientdriven-ServerPlayerMove-L24-L44 https://github.com/Unity-Technologies/com.unity.multiplayer.samples.bitesize/blob/v1.2.1/Basic/ClientDriven/Assets/Scripts/ServerPlayerMove.cs -->
[!code-csharp[ServerPlayerMove](../../snippets/ServerPlayerMove.cs#L24-L44)]
...
<!-- CodeExample: bitesize-clientdriven-ServerPlayerMove-L46-L61 https://github.com/Unity-Technologies/com.unity.multiplayer.samples.bitesize/blob/v1.2.1/Basic/ClientDriven/Assets/Scripts/ServerPlayerMove.cs -->
[!code-csharp[ServerPlayerMove](../../snippets/ServerPlayerMove.cs#L46-L61)]
