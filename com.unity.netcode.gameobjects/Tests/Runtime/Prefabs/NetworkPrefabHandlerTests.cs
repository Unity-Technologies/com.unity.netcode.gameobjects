...
namespace Unity.Netcode.RuntimeTests
{
    ...
    internal class NetworkPrefabHandlerTests
    {
        ...
        public void NetworkPrefabHandlerClass([Values] bool distributedAuthority)
        {
            ...
            var spawnedObject = networkPrefabHandler.HandleNetworkPrefabSpawn(baseObject.GlobalObjectIdHash, 0, prefabPosition, prefabRotation, null);
            ...
            spawnedObject = networkPrefabHandler.HandleNetworkPrefabSpawn(baseObject.GlobalObjectIdHash, 0, prefabPosition, prefabRotation, null);
