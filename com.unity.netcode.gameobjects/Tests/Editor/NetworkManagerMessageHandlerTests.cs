...
namespace Unity.Netcode.EditorTests
{
    public class NetworkManagerMessageHandlerTests
    {
        ...
        public void MessageHandlerReceivedMessageServerClient()
        {
            ...
            networkManager.HandleIncomingData(0, NetworkDelivery.ReliableSequenced, new ArraySegment<byte>(messageStream0.GetBuffer(), 0, (int)messageStream0.Length), 0);
            ...
            networkManager.HandleIncomingData(0, NetworkDelivery.ReliableSequenced, new ArraySegment<byte>(messageStream1.GetBuffer(), 0, (int)messageStream1.Length), 0);
            ...
            networkManager.HandleIncomingData(0, NetworkDelivery.ReliableSequenced, new ArraySegment<byte>(messageStream2.GetBuffer(), 0, (int)messageStream2.Length), 0);
            ...
            networkManager.HandleIncomingData(0, NetworkDelivery.ReliableSequenced, new ArraySegment<byte>(messageStream3.GetBuffer(), 0, (int)messageStream3.Length), 0);
            ...
            networkManager.HandleIncomingData(0, NetworkDelivery.ReliableSequenced, new ArraySegment<byte>(messageStream4.GetBuffer(), 0, (int)messageStream4.Length), 0);
            ...
            networkManager.HandleIncomingData(0, NetworkDelivery.ReliableSequenced, new ArraySegment<byte>(messageStream5.GetBuffer(), 0, (int)messageStream5.Length), 0);
            ...
            networkManager.HandleIncomingData(0, NetworkDelivery.ReliableSequenced, new ArraySegment<byte>(messageStream6.GetBuffer(), 0, (int)messageStream6.Length), 0);
            ...
            networkManager.HandleIncomingData(0, NetworkDelivery.ReliableSequenced, new ArraySegment<byte>(messageStream7.GetBuffer(), 0, (int)messageStream7.Length), 0);
            ...
            networkManager.HandleIncomingData(0, NetworkDelivery.ReliableSequenced, new ArraySegment<byte>(messageStream8.GetBuffer(), 0, (int)messageStream8.Length), 0);
            ...
            networkManager.HandleIncomingData(0, NetworkDelivery.ReliableSequenced, new ArraySegment<byte>(messageStream9.GetBuffer(), 0, (int)messageStream9.Length), 0);
            ...
            networkManager.HandleIncomingData(0, NetworkDelivery.ReliableSequenced, new ArraySegment<byte>(messageStream10.GetBuffer(), 0, (int)messageStream10.Length), 0);
            ...
            networkManager.HandleIncomingData(0, NetworkDelivery.ReliableSequenced, new ArraySegment<byte>(messageStream11.GetBuffer(), 0, (int)messageStream11.Length), 0);
            ...
            networkManager.HandleIncomingData(0, NetworkDelivery.ReliableSequenced, new ArraySegment<byte>(messageStream12.GetBuffer(), 0, (int)messageStream12.Length), 0);
            ...
            networkManager.HandleIncomingData(0, NetworkDelivery.ReliableSequenced, new ArraySegment<byte>(messageStream13.GetBuffer(), 0, (int)messageStream13.Length), 0);
            ...
            networkManager.HandleIncomingData(0, NetworkDelivery.ReliableSequenced, new ArraySegment<byte>(messageStream14.GetBuffer(), 0, (int)messageStream14.Length), 0);
            ...
            networkManager.HandleIncomingData(0, NetworkDelivery.ReliableSequenced, new ArraySegment<byte>(messageStream15.GetBuffer(), 0, (int)messageStream15.Length), 0);
            ...
            networkManager.HandleIncomingData(0, NetworkDelivery.ReliableSequenced, new ArraySegment<byte>(messageStream16.GetBuffer(), 0, (int)messageStream16.Length), 0);
            ...
            networkManager.HandleIncomingData(0, NetworkDelivery.ReliableSequenced, new ArraySegment<byte>(messageStream17.GetBuffer(), 0, (int)messageStream17.Length), 0);
            ...
            networkManager.HandleIncomingData(0, NetworkDelivery.ReliableSequenced, new ArraySegment<byte>(messageStream18.GetBuffer(), 0, (int)messageStream18.Length), 0);
            ...
            networkManager.HandleIncomingData(0, NetworkDelivery.ReliableSequenced, new ArraySegment<byte>(messageStream19.GetBuffer(), 0, (int)messageStream19.Length), 0);
            ...
            networkManager.HandleIncomingData(0, NetworkDelivery.ReliableSequenced, new ArraySegment<byte>(messageStream20.GetBuffer(), 0, (int)messageStream20.Length), 0);
            ...
            networkManager.HandleIncomingData(0, NetworkDelivery.ReliableSequenced, new ArraySegment<byte>(messageStream21.GetBuffer(), 0, (int)messageStream21.Length), 0);
