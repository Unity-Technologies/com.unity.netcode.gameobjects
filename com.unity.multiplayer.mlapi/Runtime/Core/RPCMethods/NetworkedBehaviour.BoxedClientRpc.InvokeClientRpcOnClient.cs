...
namespace MLAPI
{
    public abstract partial class NetworkedBehaviour : MonoBehaviour
    {
        ...
        {
            return SendClientRPCBoxedResponse<TResult>(HashMethod(method.Method), clientId, channel, security);
        }
        ...
        {
            return SendClientRPCBoxedResponse<TResult>(HashMethodName(methodName), clientId, channel, security);
        }
