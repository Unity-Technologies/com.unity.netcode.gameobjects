    ...
    public sealed class NetworkedObject : MonoBehaviour
    {
        ...
        public static void NetworkShow(List<NetworkedObject> networkedObjects, ulong clientId, Stream payload = null)
        {
            ...
            using (PooledBitStream stream = PooledBitStream.Get())
            {
                ...
                networkingManager.MessageSender.Send(clientId, MLAPIConstants.MLAPI_ADD_OBJECTS, Transport.MLAPI_INTERNAL_CHANNEL, stream, SecuritySendFlags.None);
            }
        }
        ...
        public void NetworkHide(ulong clientId)
        {
            ...
            using (PooledBitStream stream = PooledBitStream.Get())
            {
                using (PooledBitWriter writer = PooledBitWriter.Get(stream))
                {
                    ...
                    NetManager.MessageSender.Send(clientId, MLAPIConstants.MLAPI_DESTROY_OBJECT, Transport.MLAPI_INTERNAL_CHANNEL, stream, SecuritySendFlags.None);
                }
            }
        }
        ...
        public static void NetworkHide(List<NetworkedObject> networkedObjects, ulong clientId)
        {
            ...
            using (PooledBitStream stream = PooledBitStream.Get())
            {
                ...
                networkingManager.MessageSender.Send(clientId, MLAPIConstants.MLAPI_DESTROY_OBJECTS, Transport.MLAPI_INTERNAL_CHANNEL, stream, SecuritySendFlags.None);
            }
        }
