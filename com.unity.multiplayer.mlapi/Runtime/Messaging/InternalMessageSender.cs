...
namespace MLAPI.Messaging
{
    internal class InternalMessageSender
    {
        ...
        internal void Send(ulong clientId, byte messageType, Channel channel, BitStream messageStream, SecuritySendFlags flags)
        {
        ...
        internal void Send(byte messageType, Channel channel, BitStream messageStream, SecuritySendFlags flags)
        {
        ...
        internal void Send(byte messageType, Channel channel, List<ulong> clientIds, BitStream messageStream, SecuritySendFlags flags)
        {
            if (clientIds == null)
            {
        ...
        internal void Send(byte messageType, Channel channel, ulong clientIdToIgnore, BitStream messageStream, SecuritySendFlags flags)
        {
            bool encrypted = ((flags & SecuritySendFlags.Encrypted) == SecuritySendFlags.Encrypted) && networkingManager.NetworkConfig.EnableEncryption;
            bool authenticated = ((flags & SecuritySendFlags.Authenticated) == SecuritySendFlags.Authenticated) && networkingManager.NetworkConfig.EnableEncryption;
