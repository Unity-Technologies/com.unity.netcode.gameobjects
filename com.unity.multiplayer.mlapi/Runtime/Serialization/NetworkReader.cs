...
namespace MLAPI.Serialization
{
    ...
    public class NetworkReader
    {
        ...
        private NetworkBuffer networkSource;
        ...
        {
            source = stream;
            networkSource = stream as NetworkBuffer;
        }
        ...
        {
            if (networkSource == null) throw new InvalidOperationException($"Cannot read bits on a non-{nameof(NetworkBuffer)} stream");
