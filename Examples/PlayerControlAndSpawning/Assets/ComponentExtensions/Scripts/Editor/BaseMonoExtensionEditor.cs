...
/// <summary>
/// The custom editor for <see cref="BaseMonoExtension"/> derived classes.
/// </summary>
/// <remarks>
...
/// </remarks>
[CustomEditor(typeof(BaseMonoExtension), true)]
[CanEditMultipleObjects]
public class BaseMonoExtensionEditor : Editor
{
    ...
    private void BuildSerializedProperties()
    {
        ...
        var baseMonoExtension = target as BaseMonoExtension;
        foreach (var entry in baseMonoExtension.IsExpandedTable)
        {
    ...
    /// </summary>
    /// <param name="type">The <see cref="SerializableType"/> that is generated during <see cref="BaseMonoExtension.OnValidate"/></param>
    ...
    {
        var baseMonoExtension = target as BaseMonoExtension;
        var isExpanded = baseMonoExtension.IsExpandedTable[type];

        isExpanded = EditorGUILayout.BeginFoldoutHeaderGroup(isExpanded, $"{type.Type.Name} Properties");
        if (baseMonoExtension.IsExpandedTable[type])
        {
        ...
        baseMonoExtension.IsExpandedTable[type] = isExpanded;
    }
    ...
    public override void OnInspectorGUI()
    {
        ...
        var baseMonoExtension = target as BaseMonoExtension;
        var keys = baseMonoExtension.IsExpandedTable.Keys.ToList();
